...
Elm.Config.make = function (_elm) {
   ...
   var game_side_margin = 18;
   _elm.Config.values = {_op: _op
                        ,game_side_margin: game_side_margin
                        ,game_top_margin: game_top_margin
                        ,game_total_width: game_total_width
                        ,game_total_height: game_total_height
                        ,framerate: framerate};
   return _elm.Config.values;
};
         ...
         return function () {
            ...
            {case "_Tuple3":
               return _U.cmp(A2($HasPosition.distance,
                 pl.pos,
                 _v6._0),
                 $Player.configPlayer.radius + $Target.target_radius * (_v6._1 / $Target.target_lifespan)) < 0;}
            _U.badCase($moduleName,
   ...
   var stepPlayer = function () {
      ...
      p) {
         return function () {
            ...
            _U.badCase($moduleName,
            "between lines 62 and 75");
         }();
      });
      return step;
   }();
   var graphic = A2($Graphics$Collage.filled,
   $Color.blue,
