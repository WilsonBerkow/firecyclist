    ...
    let plats = List.map renderPlatfm game.plats
        ...
        forms' = (pauseBtn :: restartBtn :: plats)
              ...
              ++ [ move_f (Vect 10 -5) btn_outline
                 ...
                 , move_f (Vect (toFloat game_total_width / 2) 20) (Collage.toForm (Text.centered (Text.color Color.black (Text.bold (Text.typeface ["monospace", "arial"] (Text.height 30 (Text.fromString (toString (round (Time.inSeconds game.time_playing))))))))))
                 --, move_f (Vect (toFloat game_total_width / 2) (btn_outline_rad / 2 - 25)) (Collage.filled btn_outline_clr (Collage.rect (toFloat game_total_width) btn_outline_rad))
                 ]
